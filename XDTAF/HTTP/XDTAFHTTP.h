...
typedef NS_ENUM(NSInteger, XDTAFHTTPClientSSLChallengeMode) {
...
/*!
 * @abstract
 * 返回默认的HTTPClient, handler queue为main queue, 禁止缓存, 允许重定向, XDTAFHTTPClientSSLChallengeModeNone
 */
