...
zipFile xdtaf_zipOpen(const char *path, int append)
{
    zlib_filefunc64_def pzlib = mz_stream_os_get_interface();
    return xdtaf_zipOpen2(path, append, NULL, &pzlib);
}

zipFile xdtaf_zipOpen64(const void *path, int append)
{
    zlib_filefunc64_def pzlib = mz_stream_os_get_interface();
    return xdtaf_zipOpen2(path, append, NULL, &pzlib);
}

zipFile xdtaf_zipOpen2(const char *path, int append, const char **globalcomment,
    zlib_filefunc_def *pzlib_filefunc_def)
{
    return xdtaf_zipOpen2_64(path, append, globalcomment, pzlib_filefunc_def);
}

zipFile xdtaf_zipOpen2_64(const void *path, int append, const char **globalcomment,
    zlib_filefunc64_def *pzlib_filefunc_def)
{
    ...
    zip = xdtaf_zipOpen_MZ(stream, append, globalcomment);
...
zipFile xdtaf_zipOpen_MZ(void *stream, int append, const char **globalcomment)
{
...
int xdtaf_zipOpenNewFileInZip5(zipFile file, const char *filename, const zip_fileinfo *zipfi,
...
int xdtaf_zipWriteInFileInZip(zipFile file, const void *buf, uint32_t len)
{
    mz_compat *compat = (mz_compat *)file;
    int32_t written = 0;
...
int xdtaf_zipCloseFileInZipRaw(zipFile file, uint32_t uncompressed_size, uint32_t crc32)
{
    return xdtaf_zipCloseFileInZipRaw64(file, uncompressed_size, crc32);
}

int xdtaf_zipCloseFileInZipRaw64(zipFile file, int64_t uncompressed_size, uint32_t crc32)
{
    mz_compat *compat = (mz_compat *)file;
    if (compat == NULL)
        return ZIP_PARAMERROR;
...
int xdtaf_zipCloseFileInZip(zipFile file)
{
    return xdtaf_zipCloseFileInZip64(file);
}

int xdtaf_zipCloseFileInZip64(zipFile file)
{
    mz_compat *compat = (mz_compat *)file;
    if (compat == NULL)
        return ZIP_PARAMERROR;
...
int xdtaf_zipClose(zipFile file, const char *global_comment)
{
    return xdtaf_zipClose_64(file, global_comment);
}

int xdtaf_zipClose_64(zipFile file, const char *global_comment)
{
    return xdtaf_zipClose2_64(file, global_comment, MZ_VERSION_MADEBY);
}

int xdtaf_zipClose2_64(zipFile file, const char *global_comment, uint16_t version_madeby)
{
    mz_compat *compat = (mz_compat *)file;
    int32_t err = MZ_OK;

    if (compat->handle != NULL)
        err = xdtaf_zipClose2_MZ(file, global_comment, version_madeby);
...
int xdtaf_zipClose_MZ(zipFile file, const char *global_comment)
{
    return xdtaf_zipClose2_MZ(file, global_comment, MZ_VERSION_MADEBY);
}

/* Only closes the zip handle, does not close the stream */
int xdtaf_zipClose2_MZ(zipFile file, const char *global_comment, uint16_t version_madeby)
{
    mz_compat *compat = (mz_compat *)file;
    int32_t err = MZ_OK;
...
void* xdtaf_zipGetStream(zipFile file)
{
    mz_compat *compat = (mz_compat *)file;
    if (compat == NULL)
        return NULL;
...
unzFile xdtaf_unzOpen(const char *path)
{
    return xdtaf_unzOpen64(path);
}

unzFile xdtaf_unzOpen64(const void *path)
{
    zlib_filefunc64_def pzlib = mz_stream_os_get_interface();
    return xdtaf_unzOpen2(path, &pzlib);
}

unzFile xdtaf_unzOpen2(const char *path, zlib_filefunc_def *pzlib_filefunc_def)
{
    return xdtaf_unzOpen2_64(path, pzlib_filefunc_def);
}

unzFile xdtaf_unzOpen2_64(const void *path, zlib_filefunc64_def *pzlib_filefunc_def)
{
    unzFile unz = NULL;
    void *stream = NULL;
...
unzFile xdtaf_unzOpen_MZ(void *stream)
{
    mz_compat *compat = NULL;
    int32_t err = MZ_OK;
    void *handle = NULL;
...
int xdtaf_unzClose(unzFile file)
{
    mz_compat *compat = (mz_compat *)file;
    int32_t err = MZ_OK;
...
/* Only closes the zip handle, does not close the stream */
int xdtaf_unzClose_MZ(unzFile file)
{
    mz_compat *compat = (mz_compat *)file;
    int32_t err = MZ_OK;
...
int xdtaf_unzGetGlobalInfo(unzFile file, unz_global_info* pglobal_info32)
{
    mz_compat *compat = (mz_compat *)file;
    ...
    err = xdtaf_unzGetGlobalInfo64(file, &global_info64);
    if (err == MZ_OK)
    {
...
int xdtaf_unzGetGlobalInfo64(unzFile file, unz_global_info64 *pglobal_info)
{
    mz_compat *compat = (mz_compat *)file;
...
int xdtaf_unzGetGlobalComment(unzFile file, char *comment, uint16_t comment_size)
{
    mz_compat *compat = (mz_compat *)file;
    const char *comment_ptr = NULL;
    int32_t err = MZ_OK;
...
int xdtaf_unzOpenCurrentFile3(unzFile file, int *method, int *level, int raw, const char *password)
{
    mz_compat *compat = (mz_compat *)file;
...
int xdtaf_unzOpenCurrentFile(unzFile file)
{
    return xdtaf_unzOpenCurrentFile3(file, NULL, NULL, 0, NULL);
}

int xdtaf_unzOpenCurrentFilePassword(unzFile file, const char *password)
{
    return xdtaf_unzOpenCurrentFile3(file, NULL, NULL, 0, password);
}

int xdtaf_unzOpenCurrentFile2(unzFile file, int *method, int *level, int raw)
{
    return xdtaf_unzOpenCurrentFile3(file, method, level, raw, NULL);
}

int xdtaf_unzReadCurrentFile(unzFile file, void *buf, uint32_t len)
{
    mz_compat *compat = (mz_compat *)file;
    int32_t err = MZ_OK;
    if (compat == NULL || len >= INT32_MAX)
...
int xdtaf_unzCloseCurrentFile(unzFile file)
{
    mz_compat *compat = (mz_compat *)file;
    int32_t err = MZ_OK;
    if (compat == NULL)
...
int xdtaf_unzGetCurrentFileInfo(unzFile file, unz_file_info *pfile_info, char *filename,
...
int xdtaf_unzGetCurrentFileInfo64(unzFile file, unz_file_info64 * pfile_info, char *filename,
    uint16_t filename_size, void *extrafield, uint16_t extrafield_size, char *comment, uint16_t comment_size)
{
    mz_compat *compat = (mz_compat *)file;
    mz_zip_file *file_info = NULL;
...
int xdtaf_unzGoToFirstFile(unzFile file)
{
    mz_compat *compat = (mz_compat *)file;
    if (compat == NULL)
        return UNZ_PARAMERROR;
...
int xdtaf_unzGoToNextFile(unzFile file)
{
    mz_compat *compat = (mz_compat *)file;
    int32_t err = MZ_OK;
    if (compat == NULL)
...
int xdtaf_unzLocateFile(unzFile file, const char *filename, unzFileNameComparer filename_compare_func)
{
    mz_compat *compat = (mz_compat *)file;
    mz_zip_file *file_info = NULL;
...
int xdtaf_unzGetFilePos(unzFile file, unz_file_pos *file_pos)
{
    mz_compat *compat = (mz_compat *)file;
    int32_t offset = 0;
    ...
    offset = xdtaf_unzGetOffset(file);
    if (offset < 0)
        return offset;
...
int xdtaf_unzGoToFilePos(unzFile file, unz_file_pos *file_pos)
{
    mz_compat *compat = (mz_compat *)file;
    ...
    return xdtaf_unzGoToFilePos64(file, &file_pos64);
}

int xdtaf_unzGetFilePos64(unzFile file, unz64_file_pos *file_pos)
{
    mz_compat *compat = (mz_compat *)file;
    int64_t offset = 0;
    ...
    offset = xdtaf_unzGetOffset64(file);
    if (offset < 0)
        return (int)offset;
...
int xdtaf_unzGoToFilePos64(unzFile file, const unz64_file_pos *file_pos)
{
    mz_compat *compat = (mz_compat *)file;
    int32_t err = MZ_OK;
...
int32_t xdtaf_unzGetOffset(unzFile file)
{
    return (int32_t)xdtaf_unzGetOffset64(file);
}

int64_t xdtaf_unzGetOffset64(unzFile file)
{
    mz_compat *compat = (mz_compat *)file;
    if (compat == NULL)
        return UNZ_PARAMERROR;
...
int xdtaf_unzSetOffset(unzFile file, uint32_t pos)
{
    return xdtaf_unzSetOffset64(file, pos);
}

int xdtaf_unzSetOffset64(unzFile file, int64_t pos)
{
    mz_compat *compat = (mz_compat *)file;
    if (compat == NULL)
        return UNZ_PARAMERROR;
...
int xdtaf_unzGetLocalExtrafield(unzFile file, void *buf, unsigned int len)
{
    mz_compat *compat = (mz_compat *)file;
    mz_zip_file *file_info = NULL;
    int32_t err = MZ_OK;
...
int64_t xdtaf_unztell(unzFile file)
{
    mz_compat *compat = (mz_compat *)file;
    if (compat == NULL)
        return UNZ_PARAMERROR;
...
int32_t xdtaf_unzTell(unzFile file)
{
    mz_compat *compat = (mz_compat *)file;
    if (compat == NULL)
        return UNZ_PARAMERROR;
...
int64_t xdtaf_unzTell64(unzFile file)
{
    mz_compat *compat = (mz_compat *)file;
    if (compat == NULL)
        return UNZ_PARAMERROR;
...
int xdtaf_unzSeek(unzFile file, int32_t offset, int origin)
{
    return xdtaf_unzSeek64(file, offset, origin);
}

int xdtaf_unzSeek64(unzFile file, int64_t offset, int origin)
{
    mz_compat *compat = (mz_compat *)file;
    mz_zip_file *file_info = NULL;
    int64_t position = 0;
...
int xdtaf_unzEndOfFile(unzFile file)
{
    mz_compat *compat = (mz_compat *)file;
    mz_zip_file *file_info = NULL;
    int32_t err = MZ_OK;
...
void* xdtaf_unzGetStream(unzFile file)
{
    mz_compat *compat = (mz_compat *)file;
    if (compat == NULL)
        return NULL;
...
void xdtaf_fill_fopen_filefunc(zlib_filefunc_def *pzlib_filefunc_def)
{
    if (pzlib_filefunc_def != NULL)
        *pzlib_filefunc_def = mz_stream_os_get_interface();
}

void xdtaf_fill_fopen64_filefunc(zlib_filefunc64_def *pzlib_filefunc_def)
{
    if (pzlib_filefunc_def != NULL)
        *pzlib_filefunc_def = mz_stream_os_get_interface();
}

void xdtaf_fill_win32_filefunc(zlib_filefunc_def *pzlib_filefunc_def)
{
    if (pzlib_filefunc_def != NULL)
        *pzlib_filefunc_def = mz_stream_os_get_interface();
}

void xdtaf_fill_win32_filefunc64(zlib_filefunc64_def *pzlib_filefunc_def)
{
    if (pzlib_filefunc_def != NULL)
        *pzlib_filefunc_def = mz_stream_os_get_interface();
}

void xdtaf_fill_win32_filefunc64A(zlib_filefunc64_def *pzlib_filefunc_def)
{
    if (pzlib_filefunc_def != NULL)
        *pzlib_filefunc_def = mz_stream_os_get_interface();
}

void xdtaf_fill_win32_filefunc64W(zlib_filefunc64_def *pzlib_filefunc_def)
{
...
void xdtaf_fill_memory_filefunc(zlib_filefunc_def *pzlib_filefunc_def)
{
    if (pzlib_filefunc_def != NULL)
