...
typedef NS_ENUM(NSUInteger, XDTAFSAMKeychainQuerySynchronizationMode) {
	XDTAFSAMKeychainQuerySynchronizationModeAny,
	XDTAFSAMKeychainQuerySynchronizationModeNo,
	XDTAFSAMKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface XDTAFSAMKeychainQuery : NSObject
...
@property (nonatomic) XDTAFSAMKeychainQuerySynchronizationMode synchronizationMode;
#endif
