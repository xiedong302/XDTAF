...
/**
 ...
 platform.
 */
typedef NS_ENUM(OSStatus, XDTAFSAMKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	XDTAFSAMKeychainErrorBadArguments = -1001,
};

/** SAMKeychain error domain */
extern NSString *const kXDTAFSAMKeychainErrorDomain;

/** Account name. */
extern NSString *const kXDTAFSAMKeychainAccountKey;
 ...
 */
extern NSString *const kXDTAFSAMKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kXDTAFSAMKeychainClassKey;

/** Item description. */
extern NSString *const kXDTAFSAMKeychainDescriptionKey;

/** Item label. */
extern NSString *const kXDTAFSAMKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kXDTAFSAMKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kXDTAFSAMKeychainWhereKey;
 ...
 */
@interface XDTAFSAMKeychain : NSObject
