...
@class XDTAFFMStatement;

/** Represents the results of executing a query on an `<XDTAFFMDatabase>`.
...
@interface XDTAFFMResultSet : NSObject

@property (nonatomic, retain, nullable) XDTAFFMDatabase *parentDB;
...
/** `XDTAFFMStatement` used by result set. */

@property (atomic, retain, nullable) XDTAFFMStatement *statement;

///------------------------------------
/// @name Creating and closing database
///------------------------------------

/** Create result set from `<XDTAFFMStatement>`
 
 @param statement A `<XDTAFFMStatement>` to be performed
 
 @param aDB A `<XDTAFFMDatabase>` to be used
